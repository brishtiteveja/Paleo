...
if (!(stei_data_file_name %in% dir()))
  download.file(stei_ftp_data_url, stei_data_file_name)

f <- file(stei_data_file_name, 'r')
stei_data <- readLines(f)
stei_data_cols <- stei_data[157]
stei_data <- stei_data[158:length(stei_data)]
for(l in stei_data) {
  chars <- strsplit(l, "")[[1]]
  prev_c <- chars[1]
  ln <- ""
